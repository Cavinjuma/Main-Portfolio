...
export default function Contact() {
  return (
    <>
      <SEOHead
        title="Contact"
        description={`Get in touch with ${photographerInfo.name} about engineering roles, freelance work, and collaborations. ${photographerInfo.availability}`}
      />
      ...
      style={{ backgroundImage: "url('https://img.freepik.com/premium-photo/words-with-contact-us-business-concept-idea_352439-1611.jpg?w=2000')" }}
    >
      ...
      <div className="absolute inset-0 bg-black/60 z-0"></div>
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          >
            ...
            <p className="font-semibold text-lg md:text-xl text-muted-foreground tracking-wide">
